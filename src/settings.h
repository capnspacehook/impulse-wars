...
const uint8_t WEAPON_PICKUP_OBS_SIZE = NUM_WEAPON_PICKUP_OBS * (1 + 2);
const uint16_t WEAPON_PICKUP_TYPES_OBS_OFFSET = 0;
...
const uint8_t PROJECTILE_OBS_SIZE = NUM_PROJECTILE_OBS * (1 + 2);
const uint16_t PROJECTILE_TYPES_OBS_OFFSET = WEAPON_PICKUP_POS_OBS_OFFSET + (NUM_WEAPON_PICKUP_OBS * 2);
const uint16_t PROJECTILE_POS_OBS_OFFSET = PROJECTILE_TYPES_OBS_OFFSET + NUM_PROJECTILE_OBS;

const uint16_t ENEMY_DRONE_OBS_OFFSET = PROJECTILE_POS_OBS_OFFSET + (NUM_PROJECTILE_OBS * 2);
const uint8_t ENEMY_DRONE_OBS_SIZE = 4;

const uint16_t DRONE_OBS_OFFSET = ENEMY_DRONE_OBS_OFFSET + ENEMY_DRONE_OBS_SIZE;
const uint8_t DRONE_OBS_SIZE = 11;

const uint16_t SCALAR_OBS_SIZE = WEAPON_PICKUP_OBS_SIZE + PROJECTILE_OBS_SIZE + ENEMY_DRONE_OBS_SIZE + DRONE_OBS_SIZE;
