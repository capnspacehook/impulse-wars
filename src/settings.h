...
const uint16_t FLOATING_WALL_TYPES_OBS_OFFSET = 0;
...
const uint16_t SCALAR_OBS_SIZE = FLOATING_WALL_OBS_SIZE + WEAPON_PICKUP_OBS_SIZE + PROJECTILE_OBS_SIZE + ENEMY_DRONE_OBS_SIZE + DRONE_OBS_SIZE;
